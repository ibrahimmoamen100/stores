...
const faqData = [
  {
    ...
    answer:
      "يمكنك الطلب من خلال زيارة أي من فروعنا أو التواصل معنا عبر الواتساب على الرقم 01080640246. سنقوم بتوصيل طلبك خلال 48 ساعة.",
  },
  {
    question: "هل يمكنني إضافة منتجاتي إلى المتجر؟",
    answer:
      "نعم، نحن نرحب بإضافة منتجات التجار الناشئين. يمكنك التواصل معنا عبر الواتساب على الرقم 01080640246 لإضافة منتجاتك.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "يمكنك التواصل معنا عبر الواتساب على الرقم 01080640246 أو زيارة أي من فروعنا.",
  },
  {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-12 p-6 bg-white rounded-lg shadow-sm">
            ...
            <p className="text-gray-600 mb-4">
              يمكنك التواصل معنا عبر الواتساب على الرقم 01080640246 وسنكون سعداء
              بمساعدتك
            </p>
            <a
